...
use crate::{find_char_boundary, CodeStats, Language, LanguageType, Report};
...
impl<W: Write> Printer<W> {
    ...
    fn print_code_stats(
        ...
        for stats in stats.iter().map(crate::CodeStats::summarise) {
            code += stats.code;
    ...
    fn print_language_total(&mut self, parent: &Language) -> io::Result<()> {
        ...
        let mut subtotal = crate::Report::new("(Total)".into());
    ...
    pub fn print_total(&mut self, languages: &crate::Languages) -> io::Result<()> {
